  ...
  methods: {
    ...
    loadLevelsOfScaffolding: function() {
      axios
        .get(
          this.$apiAdress +
            "/api/student/getLevelsOfScaffolding?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    LoadLocations: function() {
      axios
        .get(
          this.$apiAdress +
            "/api/student/getLocationInstructionalCycle?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    LoadInstructionalPurposes: function() {
      axios
        .get(
          this.$apiAdress +
            "/api/student/getInstructionalPurpose?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    gotoactivity(activityid) {
      this.$router.push({
        path: `/student-classes/${this.myId.toString()}/myclass/${activityid.toString()}/activity`,
      });
    },
    getimage(image) {
