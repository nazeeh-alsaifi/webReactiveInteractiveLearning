...
export default {
  ...
  methods: {
    ...
    addToClass(id){
      ...
      axios.post(
          this.$apiAdress +
            "/api/Teachers/class_Activities?&token=" +
    ...
    removeFromClass(id){
      ...
      axios.post(
          this.$apiAdress +
            "/api/Teachers/remove_class_Activities?&token=" +
            localStorage.getItem("api_token"),formData
        )
         .then((response) => {
          this.ClearSearch();
    ...
    loadLevelsOfScaffolding: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/Teachers/getLevelsOfScaffolding?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    LoadLocations: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/Teachers/getLocationInstructionalCycle?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    LoadInstructionalPurposes: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/Teachers/getInstructionalPurpose?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
