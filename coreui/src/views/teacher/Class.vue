...
import axios from 'axios'
    ...
    methods:{
        ...
        loadSubjects: function() {
            axios
                .get(this.$apiAdress +'/api/Teachers/'+this.myId+'/getMyClassSubject?token='+ localStorage.getItem("api_token"))
                .then(response => {
        ...
        loadStudents: function(){
                    axios.get(this.$apiAdress +'/api/Teachers/getStudents?search=' +
                        this.searchtext +
                        "&sort_field=" +
                        this.sort_field +
                        "&sort_direction=" +
        ...
        loadStudentClasses: function(){
            axios
                .get(this.$apiAdress +'/api/Teachers/'+this.myId+'/getStudentClasses?token='+ localStorage.getItem("api_token"))
                .then(response => {
