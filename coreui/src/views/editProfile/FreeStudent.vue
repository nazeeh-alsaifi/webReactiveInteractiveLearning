                ...
                <div class="container">
                  ...
                  <div v-if="fields.image" class="form-group row mb-0">
                    <div class="col-md-8 offset-md-4">
                      <img
                        style="width: 20%; high: 30%; border-radius: 50%"
                        :src="getphoto()"
                        alt="Profile Image"
                      />
                      <input
  ...
  methods: {
    ...
    loadusers: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/freestudent/getUsers?token=" +
    ...
    loadnationalities: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/freestudent/getNationalities?token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    loadstudent: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/freestudent/getStudent?token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    submit() {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/freeStudents/storeuserprofile?token=" +
            localStorage.getItem("api_token"),
          this.fields
        )
        .then((response) => {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/freeStudents/storestudentprofile?token=" +
            localStorage.getItem("api_token"),
          formData
        )
        .then((response) => {
