  ...
  <CRow>
    ...
    <form @submit.prevent="submit">
        ...
        <div class="form-group row"> 
            ...
            <div class="col-md-6">
                <input id="First_name" type="text" class="form-control" minlength="3" name="First_name" v-model="teacher.First_name" required autofocus>
            ...
            <div class="col-md-6">
                <input id="Last_Name" type="text" class="form-control" minlength="3" name="Last_Name" v-model="teacher.Last_Name" required autofocus>
        ...
        <div class="form-group row"> 
            ...
            <div class="col-md-6">
                <input id="Mobile" type="tel" class="form-control" pattern="[0]{1}[0-9]{9,12}" name="Mobile" v-model="teacher.Mobile" required autofocus>
            ...
            <div class="col-md-6">
                <input id="birth_date" type="date" class="form-control" name="Mobile" v-model="teacher.birth_date" required autofocus>
                ...
                <label for="nationality_id" class="col-md-4 col-form-label text-md-right">Nationality</label>
                     <div class="col-md-6">
                        <select
                            ...
                            name="nationality_id"
                            v-model="teacher.nationality_id"
                            required
                            autofocus
                        >
                            <option
          ...
          <div style="display:inline-block; width:50%;">
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" id="Gender" style="width:250%;" name="Gender"
                    v-model="teacher.Gender" required autofocus>
                    <option value=""></option>
...
export default {
       data() {
        ...
        methods: {
            ...
            loadusers: function(){
                       axios.get(this.$apiAdress +'/api/Coordintors/getUsers?token=' + localStorage.getItem("api_token"))
                    .then((response) => {
            ...
            loadnationalities: function(){
                    axios.get(this.$apiAdress +'/api/Coordintors/getNationalities?token='+ localStorage.getItem("api_token"))
                    .then((response) => {
            ...
            submit() {
                ...
                axios.post(this.$apiAdress +'/api/coordintors/storeuserprofile?token='+ localStorage.getItem("api_token"),this.fields).then(response => {
                    this.fields = {};
                    this.success = true;
                    this.errors = {};
                }).catch(error => {
                ...
                axios.post(this.$apiAdress +'/api/coordintors/storeteacherprofile?token='+ localStorage.getItem("api_token"), formData).then(response => {
                    this.teacher = {};
                    this.success = true;
                    this.errors = {};
                    this.loadusers();
