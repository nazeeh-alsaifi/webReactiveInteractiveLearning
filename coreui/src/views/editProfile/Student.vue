  ...
  methods: {
    ...
    loadnationalities: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/student/getNationalities?token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    submit() {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/Students/storeuserprofile?token=" +
            localStorage.getItem("api_token"),
          this.fields
        )
        .then((response) => {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/Students/storestudentprofile?token=" +
            localStorage.getItem("api_token"),
          formData
        )
        .then((response) => {
