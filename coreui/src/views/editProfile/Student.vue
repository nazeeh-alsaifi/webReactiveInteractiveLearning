  ...
  <CRow>
    ...
    <form @submit.prevent="submit">
        ...
        <div class="form-group row"> 
            ...
            <div class="col-md-6">
                <input id="First_Name" type="text" class="form-control" minlength="3" name="First_Name" v-model="student.First_Name" required autofocus>
            ...
            <div class="col-md-6">
                <input id="Last_Name" type="text" class="form-control" minlength="3" name="Last_Name" v-model="student.Last_Name" required autofocus>
        ...
        <div class="form-group row"> 
            ...
            <div class="col-md-6">
                <input id="Mobile" type="tel" class="form-control" pattern="[0]{1}[0-9]{9,12}" name="Mobile" v-model="student.Mobile" required autofocus>
            ...
            <div class="col-md-6">
                <input id="birth_date" type="date" class="form-control" name="Mobile" v-model="student.birth_date" required autofocus>
                ...
                <label for="nationality_id" class="col-md-4 col-form-label text-md-right">Nationality</label>
                     <div class="col-md-6">
                        <select
                            ...
                            name="nationality_id"
                            v-model="student.nationality_id"
                            required
                            autofocus
                        >
                            <option
          ...
          <div style="display:inline-block; width:50%;">
            ...
            <div class="col-md-6">
                ...
                <select class="form-control" id="Gender" style="width:250%;" name="Gender"
                    v-model="student.Gender" required autofocus>
                    <option value=""></option>
            ...
            <div  v-if="passwordshow">
            <div>
                <input id="password" style="width:50%;" type="text" class="form-control" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" name="password" v-model="fields.password" required autofocus>
...
export default {
        ...
        methods: {
            getphoto(){
               return "../../storage/image/"+this.freshuser.image;
            },
            getempty(){
            ...
            loadusers: function(){
                    axios.get(this.$apiAdress +'/api/student/getUsers?token=' + localStorage.getItem("api_token"))
                    .then((response) => {
            ...
            loadnationalities: function(){
                    axios.get(this.$apiAdress +'/api/student/getNationalities?token='+ localStorage.getItem("api_token"))
                    .then((response) => {
            ...
            loadstudent: function(){
                    axios.get(this.$apiAdress +'/api/student/getStudent?token=' + localStorage.getItem("api_token"))
                    .then((response) => {
                        this.students = response.data;
                        this.student = this.filterstudent()[0];
                    })
                    .catch(function (error) {
                        console.log(error);
                    });
            ...
            filterstudent: function(){
                ...
                return (student.user_id==this.user);
                });
            },
            submit() {
                const formData = new FormData
                formData.set('image',this.image)
                formData.set('id',this.student.id)
                formData.set('First_Name',this.student.First_Name)
                formData.set('Last_Name',this.student.Last_Name)
                formData.set('Mobile',this.student.Mobile)
                formData.set('Gender',this.student.Gender)
                formData.set('birth_date',this.student.birth_date)
                formData.set('nationality_id',this.student.nationality_id)
                if(!this.fields.password)
                {
                    this.fields.password = this.user.password;
                }
                axios.post(this.$apiAdress +'/api/Students/storeuserprofile?token=' + localStorage.getItem("api_token"),this.fields).then(response => {
                    this.fields = {};
                    this.success = true;
                    this.errors = {};
                }).catch(error => {
                ...
                axios.post(this.$apiAdress +'/api/Students/storestudentprofile?token=' + localStorage.getItem("api_token"), formData).then(response => {
                    this.student = {};
                    this.success = true;
                    this.errors = {};
                    this.loadusers();
