  ...
  methods: {
    ...
    loadusers: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/SubjectCoordinators/getUsers?token=" +
    ...
    loadnationalities: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/SubjectCoordinators/getNationalities?token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    loadteacher: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/SubjectCoordinators/getTeachers?token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    submit() {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/SubjectCoordinators/storeuserprofile?token=" +
            localStorage.getItem("api_token"),
          this.fields
        )
        .then((response) => {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/SubjectCoordinators/storeteacherprofile?token=" +
            localStorage.getItem("api_token"),
          formData
        )
        .then((response) => {
