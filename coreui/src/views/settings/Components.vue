    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table style="table-layout:fixed" class="table table-striped">
                    ...
                    <tr style="width:100%;">
                        ...
                        <th style="text-align:left;width:20%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('Component_name')">Name</a>
                            <span v-if="this.sort_field=='Component_name' && this.sort_direction=='asc'" @click.prevent="change_sort('Component_name')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='Component_name' && this.sort_direction=='desc'" @click.prevent="change_sort('Component_name')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="text-align:left;width:20%;">
                           <div style="text-align:left;">
                        ...
                        <th style="text-align:left;width:30%;"> 
                           <input style="width:100%;" type="search" v-model="searchtext" placeholder="search components"/>                                
                        </th>
                        <th style="text-align:left;width:20%;">
                            <a>COL</a>
                            <select style="width:12%;" class="btn btn-info" v-model="column">
                                <option class="form-control" :value="'Component_name'">Component_name</option>
                                <option class="form-control" :value="'Description'">Description</option>
                            </select>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr v-for="component in components.data" v-bind:key="component.id">
                            <td>
                            ...
                            <td>
                                <div>
                                    ...
                                    >
                                    <button
                                    v-on:click="cancelEdit()" v-if="component.id == editfields.id"
                                    class="btn btn-outline-danger"
                                    >Cancel Edit</button
                                    >
                                </div>
                ...
                <pagination :data="components" @pagination-change-page="loadComponents"></pagination>
            </div>
        </div>
    </div>
          </CCardBody>
...
export default {
    ...
    methods: {
        ...
        loadComponents(page = 1) {
            axios.get(this.$apiAdress +'/api/component/getpage?page=' + page
