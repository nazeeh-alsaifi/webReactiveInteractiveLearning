            ...
            <div class="container">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input
                        ...
                        class="form-control"
                        name="Nationality_name"
                        v-model="editfields.Nationality_name"
                        required
                        autofocus
                      />
                      <div
                        class="alert alert-danger"
                        v-if="errors && errors.Nationality_name"
                      >
                        {{ errors.Nationality_name[0] }}
                      </div>
                    </div>
                  </div>
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                      ...
                      <tr>
                        ...
                        <th style="text-align:left;width:25%;">
                          <div style="text-align:left;">
                            ...
                            <span
                              v-if="
                                this.sort_field == 'Nationality_name' &&
                                  this.sort_direction == 'asc'
                              "
                              @click.prevent="change_sort('Nationality_name')"
                              ><CIcon name="cil-arrow-top" /></span
                      ...
                      >
                        ...
                        <td>
                          ...
                          >
                            ...
                            >
                              <a
                                v-on:click="editNationality(nationality)"
                                v-if="!edit && nationality.id != editfields.id"
                                class="btn btn-info"
                                >Edit</a
                              >
                              <button
                  ...
                  <pagination
                    :data="nationalities"
                    @pagination-change-page="loadNationalities"
                  ></pagination>
                </div>
              </div>
            </div>
  ...
  methods: {
    ...
    update() {
      ...
      axios
        .post(
          this.$apiAdress +
            "/api/nationalities/store1?token=" +
            localStorage.getItem("api_token"),
          this.editfields
        )
        .then((response) => {
    ...
    deleteNationality(id) {
      axios
        .post(
          this.$apiAdress +
            "/api/nationalities/delete?token=" +
            localStorage.getItem("api_token"),
          id
        )
        .then((data) => {
