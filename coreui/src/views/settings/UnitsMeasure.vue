    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table style="table-layout:fixed" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th style="text-align:left;width:20%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('Unit_measure')">Name</a>
                            <span v-if="this.sort_field=='Unit_measure' && this.sort_direction=='asc'" @click.prevent="change_sort('Unit_measure')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='Unit_measure' && this.sort_direction=='desc'" @click.prevent="change_sort('Unit_measure')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="text-align:left;width:10%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('unit_id')">Unit</a>
                            <span v-if="this.sort_field=='unit_id' && this.sort_direction=='asc'" @click.prevent="change_sort('unit_id')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='unit_id' && this.sort_direction=='desc'" @click.prevent="change_sort('unit_id')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="text-align:left;width:20%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('Measure_sample')">Measure_sample</a>
                            <span v-if="this.sort_field=='Measure_sample' && this.sort_direction=='asc'" @click.prevent="change_sort('Measure_sample')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='Measure_sample' && this.sort_direction=='desc'" @click.prevent="change_sort('Measure_sample')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="width:30%;">
                            <input style="width:100%;" type="search" v-model="searchtext" placeholder="search unit_measure"/>
                        </th>
                        <th style="width:10%;"></th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr v-for="unitsmeasure in unitmeasures.data" v-bind:key="unitsmeasure.id">
                             <td>
                            ...
                            <td>
                                ...
                                <form
                                    ...
                                    v-if="
                                        edit && unitsmeasure.id == editfields.id
                                    "
                                >
                                    <div class="container">
                                        <div class="form-group row">
                ...
                <pagination :data="unitmeasures" @pagination-change-page="loadUnitsMeasure"></pagination>
            </div>
        </div>
    </div>
