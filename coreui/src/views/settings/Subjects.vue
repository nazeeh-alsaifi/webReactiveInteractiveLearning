    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <form @submit.prevent="submit" v-if="add">
                <div class="container">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="Subject_name" type="text" minlength="3" class="form-control" 
                                   name="Subject_name" v-model="fields.Subject_name" required autofocus/>
            ...
            <div class="panel-body">
                ...
                <table style="table-layout:fixed" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th style="text-align:left;width:30%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('Subject_name')">Name</a>
                            <span v-if="this.sort_field=='Subject_name' && this.sort_direction=='asc'" @click.prevent="change_sort('Subject_name')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='Subject_name' && this.sort_direction=='desc'" @click.prevent="change_sort('Subject_name')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="width:30%;">
                                ...
                                >
                                    <div class="container">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="Subject_name" type="text" minlength="3"
                                                    class="form-control" name="Subject_name"
                                                    v-model="editfields.Subject_name" required autofocus/>
                                                <div
                ...
                <pagination :data="subjects" @pagination-change-page="loadSubjects"></pagination>
            </div>
        </div>
    </div>
          </CCardBody>
