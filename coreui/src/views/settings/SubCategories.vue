            ...
            <div class="container">
              <div class="panel panel-default">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input
                          ...
                          class="form-control"
                          name="sub_cat_name"
                          v-model="editfields.sub_cat_name"
                          required
                          autofocus
                        />
                        <div
                          class="alert alert-danger"
                          v-if="errors && errors.sub_cat_name"
                        >
                ...
                <div class="panel-body">
                      ...
                      <tr>
                        ...
                        <th style="text-align:left; width:25%;">
                          <div style="text-align:left;">
                            <a
                              style="text-align:left;"
                              @click.prevent="change_sort('sub_cat_name')"
                              >Name</a
                            >
                            <span
                              v-if="
                                this.sort_field == 'sub_cat_name' &&
                                  this.sort_direction == 'asc'
                              "
                              @click.prevent="change_sort('sub_cat_name')"
                              ><i class="fa-fw select-all fas"></i></span
                        ...
                        <th style="text-align:left;width:25%;">
                          <div style="text-align:left;">
                            <a
                              style="text-align:left;;"
                              @click.prevent="change_sort('category_id')"
                              >Category</a
                            >
                            <span
                              v-if="
                                this.sort_field == 'category_id' &&
                                  this.sort_direction == 'asc'
                              "
                              @click.prevent="change_sort('category_id')"
                              ><i class="fa-fw select-all fas"></i></span
                      ...
                      >
                        ...
                        <td>
                          ...
                          >
                            <div
                              ...
                              v-if="category.id == sub_category.category_id"
                            >
                              {{ category.Cat_name }}
                            </div>
                          </div>
                          ...
                          >
                            ...
                            >
                              <button
                                ...
                                v-if="!edit && sub_category.id != editfields.id"
                                class="btn btn-info"
                              >
                                Edit
                              </button>
                        ...
                        <td>
                          ...
                          >
                            ...
                            >
                              <button
                                @click="deleteSubCategory(sub_category)"
                  ...
                  <pagination
                    :data="sub_categories"
                    @pagination-change-page="loadSubCategories"
                  ></pagination>
                </div>
              </div>
            </div>
  ...
  methods: {
    ...
    update() {
      axios
        .post(
          this.$apiAdress +
            "/api/subCategories/store1?token=" +
            localStorage.getItem("api_token"),
          this.editfields
        )
        .then((response) => {
    ...
    deleteSubCategory(id) {
      axios
        .post(
          this.$apiAdress +
            "/api/subCategories/delete?token=" +
            localStorage.getItem("api_token"),
          id
        )
        .then((data) => {
