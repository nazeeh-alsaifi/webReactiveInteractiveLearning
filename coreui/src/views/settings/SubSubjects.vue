              ...
              <div class="panel panel-default">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input
                          ...
                          class="form-control"
                          name="sub_subject_name"
                          v-model="editfields.sub_subject_name"
                          required
                          autofocus
                        />
                        <div
                ...
                <div class="panel-body">
                  ...
                  <table style="table-layout:fixed" class="table table-striped">
                      ...
                      <tr>
                        ...
                        <th style="text-align:left; width:25%;">
                          <div style="text-align:left;">
                            <a
                              style="text-align:left;"
                              @click.prevent="change_sort('sub_subject_name')"
                              >Name</a
                            >
                            <span
                              v-if="
                                this.sort_field == 'sub_subject_name' &&
                                  this.sort_direction == 'asc'
                              "
                              @click.prevent="change_sort('sub_subject_name')"
                              ><CIcon name="cil-arrow-top" /></span
                        ...
                        <th style="width:30%;">
                          <input
                            ...
                            type="search"
                            v-model="searchtext"
                            placeholder="search sub_subject"
                          />
                        </th>
                    ...
                    <tbody>
                      <tr
                        v-for="subsubject in sub_subjects.data"
                        v-bind:key="subsubject.id"
                      >
                        <td>
                        ...
                        <td>
                          ...
                          >
                            <div
                              ...
                              v-if="subject.id == subsubject.subject_id"
                            >
                          ...
                          >
                            ...
                            >
                              <button
                                ...
                                v-if="!edit && subsubject.id != editfields.id"
                                class="btn btn-info"
                              >
                                Edit
                              </button>
                  ...
                  <pagination
                    :data="sub_subjects"
                    @pagination-change-page="loadSubSubjects"
                  ></pagination>
                </div>
              </div>
            </div>
