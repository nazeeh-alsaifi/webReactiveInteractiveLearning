            ...
            <div class="container">
              <div class="panel panel-default">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input
                          ...
                          class="form-control"
                          name="Sample_unit"
                          v-model="editfields.Sample_unit"
                          required
                          autofocus
                        />
                        <div
                ...
                <div class="panel-body">
                      ...
                      <tr>
                        ...
                        <th style="text-align:left; width:25%;">
                          <div style="text-align:left;">
                            <a
                              style="text-align:left;"
                              @click.prevent="change_sort('unit_name')"
                              >Name</a
                            >
                            <span
                              v-if="
                                this.sort_field == 'unit_name' &&
                                  this.sort_direction == 'asc'
                              "
                              @click.prevent="change_sort('unit_name')"
                              ><i class="fa-fw select-all fas"></i></span
                        ...
                        <th style="text-align:left; width:25%;">
                          <div style="text-align:left;">
                            <a
                              style="text-align:left;"
                              @click.prevent="change_sort('Sample_unit')"
                              >Sample</a
                            >
                            <span
                              v-if="
                                this.sort_field == 'Sample_unit' &&
                                  this.sort_direction == 'asc'
                              "
                              @click.prevent="change_sort('Sample_unit')"
                              ><i class="fa-fw select-all fas"></i></span
                        ...
                        <th style="width:10%;">
                          ...
                          <select
                            ...
                            v-model="column"
                          >
                            <option class="form-control" :value="'unit_name'"
                              >Unit Name</option
                            >
                            <option class="form-control" :value="'Sample_unit'"
                              >Sample Unit</option
                            >
                          </select>
                        </th>
                  ...
                  <pagination
                    :data="units"
                    @pagination-change-page="loadUnits"
                  ></pagination>
                </div>
              </div>
            </div>
