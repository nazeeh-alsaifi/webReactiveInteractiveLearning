                   ...
                   <thead >
                    <tr>
                        ...
                        <th style="text-align:left;width:20%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('Cat_name')">Name</a>
                            <span v-if="this.sort_field=='Cat_name' && this.sort_direction=='asc'" @click.prevent="change_sort('Cat_name')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='Cat_name' && this.sort_direction=='desc'" @click.prevent="change_sort('Cat_name')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="text-align:left;width:20%;">
                            <div style="text-align:left;">
                        ...
                        <th style="width:35%;">
                            <input style="width:100%;" type="search" v-model="searchtext" placeholder="search category"/>
                        </th>
                            ...
                            <td>
                                <div v-for="permission in permissions" v-bind:key="permission.id">
                                    ...
                                    <form
                                        ...
                                        v-if="
                                            edit && category.id == editfields.id
                                        "
                                    >
                                        <div class="container">
                                            <div class="form-group row">
