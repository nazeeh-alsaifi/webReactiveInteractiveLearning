    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div style="text-align:left">
                    ...
                    >
                     <div v-if="permission.permission =='add Settings'">
                        <a v-on:click="addInstructionalPurpose()" class="btn btn-info"
                ...
                <table style="table-layout:fixed" class="table table-striped">
                    ...
                    <tr>
                       ...
                       <th style="text-align:left;width:25%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('Instructional_Purpose')">Name</a>
                            <span v-if="this.sort_field=='Instructional_Purpose' && this.sort_direction=='asc'" @click.prevent="change_sort('Instructional_Purpose')"><i class="fa-fw select-all fas"></i></span>
                            <span v-if="this.sort_field=='Instructional_Purpose' && this.sort_direction=='desc'" @click.prevent="change_sort('Instructional_Purpose')"><i class="fa-fw select-all fas"></i></span>
                            </div>
                        </th>
                        <th style="width:35%;">
                            <input style="width:100%;" type="search" v-model="searchtext" placeholder="search Instructional_Purpose"/>
                        </th>
                        <th style="width:10%;"></th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr v-for="Instructional_Purpose in Instructional_Purposes.data" v-bind:key="Instructional_Purpose.id">
                            <td>
                            ...
                            <td>
                                ...
                                <form
                                    ...
                                    v-if="
                                        edit && Instructional_Purpose.id == editfields.id
                                    "
                                >
                                    <div class="container">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input
                                                    ...
                                                    name="Instructional_Purpose"
                                                    v-model="
                                                        editfields.Instructional_Purpose
                                                    "
                                                    required
                                                    autofocus
                                                />
                                                <div
                                                    ...
                                                    v-if="
                                                        errors &&
                                                            errors.Instructional_Purpose
                                                    "
                                                >
                                                    {{
                                                        errors
                                                            .Instructional_Purpose[0]
                                                    }}
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <td>
                                ...
                                <div v-if="permission.permission =='delete Settings'">
                                    <button
                                        @click="
                                            deleteInstructionalPurpose(Instructional_Purpose)
                                        "
                ...
                <pagination :data="Instructional_Purposes" @pagination-change-page="loadInstructionalPurpose"></pagination>
            </div>
        </div>
    </div>
          </CCardBody>
    ...
    mounted() {
     ...
     watch:{
        ...
        loadInstructionalPurpose: function(page = 1) {
            axios
                .get(this.$apiAdress +'/api/instructionalPurpose/getpage?page=' + page
        ...
        submit() {
            axios
                .post(this.$apiAdress +'/api/InstructionalPurpose?token='+ localStorage.getItem("api_token"), this.fields)
                .then(response => {
                    this.fields = {};
                    this.success = true;
                    this.add = false;
        ...
        update() {
            axios;
            axios
                .post(this.$apiAdress +'/api/instructionalPurpose/store1?token='+ localStorage.getItem("api_token"), this.editfields)
                .then(response => {
                    this.editfields = {};
                    this.edit = false;
                    this.successedit = true;
        ...
        deleteInstructionalPurpose(id) {
            axios
                .post(this.$apiAdress +'/api/instructionalPurpose/delete?token='+ localStorage.getItem("api_token"), id)
                .then(data => {
