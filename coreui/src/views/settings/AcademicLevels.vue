                ...
                <table style="table-layout:fixed" class="table table-striped">
                    ...
                    <tr>
                       <th style="text-align:left;width:10%;">
                            ...
                            <span v-if="this.sort_field=='id' && this.sort_direction=='asc'" @click.prevent="change_sort('id')"><i class="cil-arrow-top"></i></span>
                            <span v-if="this.sort_field=='id' && this.sort_direction=='desc'" @click.prevent="change_sort('id')"><i class="cil-arrow-bottom"></i></span>
                            </div>
                        </th>
                         <th style="text-align:left;width:30%;">
                            <div style="text-align:left;">
                            <a style="text-align:left;" @click.prevent="change_sort('AcademicLevel')">Name</a>
                            <span v-if="this.sort_field=='AcademicLevel' && this.sort_direction=='asc'" @click.prevent="change_sort('AcademicLevel')"><i class="cil-arrow-top"></i></span>
                            <span v-if="this.sort_field=='AcademicLevel' && this.sort_direction=='desc'" @click.prevent="change_sort('AcademicLevel')"><i class="cil-arrow-bottom"></i></span>
                            </div>
                        </th>
                        <th style="width:30%;">   
                            <input style="width:100%;" type="search" v-model="searchtext" placeholder="search academic level"/>
                        </th>
                        <th style="width:10%;"></th>
                    </tr>
                     </thead>
                    <tbody>
                        <tr v-for="academiclevel in academiclevels.data" v-bind:key="academiclevel.id">
                            <td style="width:10%;">
                 ...
                 <pagination :data="academiclevels" @pagination-change-page="loadAcademiclevels"></pagination>
            </div>
        </div>
    </div>
          </CCardBody>
