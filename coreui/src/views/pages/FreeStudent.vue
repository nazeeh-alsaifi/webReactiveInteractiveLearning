 ...
 <div class="container">
    ...
    <form @submit.prevent="submit">
        ...
        <div class="form-group row"> 
            ...
            <div class="col-md-6">
                <input id="Mobile" type="text" class="form-control" pattern="[0]{1}[0-9]{9,12}" name="Mobile" v-model="fields.Mobile" required autofocus>
...
export default {
   data: () => {
        ...
        filteredCities: function(){
         //this.tempcomponents = this.components.data
     ...
     methods: {
        loadSubjects: function () {
          ...
          loadCities: function () {
            ...
            submit() {
               let self = this;
               axios.post(this.$apiAdress +'/api/Purchase/Free_Student', this.fields).then(response => {
               this.fields = {};
               this.success = true;
               this.errors = {};
