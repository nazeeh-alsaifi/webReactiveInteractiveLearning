<template>
 ...
 <div class="container">
        <div class="row">
          ...
          <div v-for="(subject,index) in subjects" v-bind:key="subject.id">
            <h6 class="mt-2" @click="chooseSubject(subject.id)" >{{index+1}}.{{subject.Subject_name}}:</h6>            
            ...
            <h6 style="color:red;" class="mt-2">InstructionalCycle_Locations:</h6>
              <div class="form-check">
              <CInputCheckbox
            ...
            <h6 style="color:red;" class="mt-2">Levels Of Scaffolding:</h6>
              <div class="form-check">
              <CInputCheckbox
              ...
              <h6 style="color:red;" class="mt-2">InstructionalPurposes:</h6>
              <div class="form-check">
              <CInputCheckbox
                  ...
                  v-on:change="InstructionalPurposeschange(InstructionalPurpose.id)"
            ...
            <button
              ...
              >
               Clear  
                ...
                <div class="row mt-4">
                    <div class="col-lg-4 col-md-6 mb-4" v-for="myActivity in myActivities.data" v-bind:key="myActivity.id">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">
                                     <a  style="color:blue;" @click="gotoactivity(myActivity.id)"> {{ myActivity.title }} </a>
                                </h4>
...
export default {
    ...
    loadSubjects: function(){
          axios.get(this.$apiAdress +'/api/Employees/getSubjects?&token='+ localStorage.getItem("api_token"))
                .then(response => {
                    this.subjects = response.data;
                })
    },
    loadSubSubjects: function(){
          axios.get(this.$apiAdress +'/api/Employees/getSubSubjects?&token='+ localStorage.getItem("api_token"))
                .then(response => {
                    this.SubSubjects = response.data;
                })
    },
    loadLevelsOfScaffolding: function(){
          axios.get(this.$apiAdress +'/api/Employees/getLevelsOfScaffolding?&token='+ localStorage.getItem("api_token"))
                .then(response => {
                    this.LevelsOfScaffolding = response.data;
                })
    },
    LoadLocations: function(){
          axios.get(this.$apiAdress +'/api/Employees/getLocationInstructionalCycle?&token='+ localStorage.getItem("api_token"))
                .then(response => {
                    this.Locations = response.data;
                })
    },
    LoadInstructionalPurposes: function(){
          axios.get(this.$apiAdress +'/api/Employees/getInstructionalPurpose?&token='+ localStorage.getItem("api_token"))
                .then(response => {
