...
export default {
  ...
  methods: {
    ...
    gotoactivity(activityid) {
      //this.$router.go(-1);
      this.$router.push({
        path: `/coordinator-teachers/${this.teacherid.toString()}/teacherclasses/${this.myId.toString()}/myclass/myactivities/${activityid.toString()}/activity`,
      });
    },
    addToClass(id){
    ...
    loadLevelsOfScaffolding: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/Coordintors/getLevelsOfScaffolding?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    LoadLocations: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/Coordintors/getLocationInstructionalCycle?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    LoadInstructionalPurposes: function () {
      axios
        .get(
          this.$apiAdress +
            "/api/Coordintors/getInstructionalPurpose?&token=" +
            localStorage.getItem("api_token")
        )
        .then((response) => {
    ...
    loadMyActivities: function(page = 1) {
      axios
        .get(
          this.$apiAdress +
            "/api/Coordintors/" + this.myId + "/getMyActivities?page=" +
            page +
            "&search=" +
            this.searchtext +
            "&is_free=" +
