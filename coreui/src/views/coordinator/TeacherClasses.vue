...
export default {
     data: function() {
        ...
        gotoclass(id){
            //this.$router.go(-1)
            this.$router.push({path: `/coordinator-teachers/${this.myId.toString()}/teacherclasses/${id.toString()}/myclass`});
        },    
        change_sort(field) {
        ...
        loadmyTeacher: function() {
            axios
                .get(this.$apiAdress +'/api/Coordintors/'+this.myId+'/getMyTeacher?token='+ localStorage.getItem("api_token"))
                .then(response => {
        ...
        loadInstitutionSubject: function(){
            axios
                .get(this.$apiAdress +'/api/Coordintors/getAllInstitutionSubject?token='+ localStorage.getItem("api_token"))
                .then(response => {
        ...
        loadkeyclasses: function(page = 1){
            axios.get(this.$apiAdress +'/api/Coordintors/'+this.myId+'/getTeacherClasses?page='+page+
                        "&search=" +
                        this.searchtext +
                        "&sort_field=" +
                        this.sort_field +
