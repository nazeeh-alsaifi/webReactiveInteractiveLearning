...
export default {
     data: function() {
        ...
        gotoclass(id){
            //this.$router.go(-1)
            this.$router.push({path: `/subject-coordinator-teachers/${this.myId.toString()}/teacherclasses/${id.toString()}/myclass`});
        },    
        change_sort(field) {
        ...
        loadTeachers: function(){
                    axios.get(this.$apiAdress +'/api/SubjectCoordinators/getTeachers?token='+ localStorage.getItem("api_token"))
                    .then((response) => {
        ...
        loadSubjects: function() {
            axios
                .get(this.$apiAdress +'/api/SubjectCoordinators/getSubjects?token='+ localStorage.getItem("api_token"))
                .then(response => {
        ...
        loadmyTeacher: function() {
            axios
                .get(this.$apiAdress +'/api/SubjectCoordinators/'+this.myId+'/getMyTeacher?token='+ localStorage.getItem("api_token"))
                .then(response => {
        ...
        loadInstitutionSubject: function(){
            axios
                .get(this.$apiAdress +'/api/SubjectCoordinators/getAllInstitutionSubject?token='+ localStorage.getItem("api_token"))
                .then(response => {
        ...
        loadkeyclasses: function(page = 1){
            axios.get(this.$apiAdress +'/api/SubjectCoordinators/'+this.myId+'/getTeacherClasses?page='+page+
                        "&search=" +
                        this.searchtext +
                        "&sort_field=" +
                        this.sort_field +
